...
public final class FormRecognizerClientImpl {
    ...
    public interface FormRecognizerClientService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<Response<ModelInfo>> getModelInfo(
                @HostParam("endpoint") String endpoint,
                @HostParam("ApiVersion") String apiVersion,
                @PathParam("modelId") String modelId,
                @HostParam("ApiVersion") String apiVersionParam,
    ...
    public Mono<TrainModelResponse> trainModelWithResponseAsync(
        ...
        return service.trainModel(
                this.getEndpoint(), this.getApiVersion(), this.getApiVersion(), trainRequest, accept, context);
    }
    ...
    public Mono<PagedResponse<ModelInfo>> listModelsSinglePageAsync(Context context) {
        final String accept = "application/json";
        return service.listModels(this.getEndpoint(), this.getApiVersion(), this.getApiVersion(), accept, context)
                .map(
                        res ->
                                new PagedResponseBase<>(
                                        res.getRequest(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ModelInfo>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ModelInfo> getModelInfoAsync(
            String modelId) {
    ...
    public Mono<Response<Paths1Ep1Fe8InfoGetResponses200ContentApplicationJsonSchema>> getResourceInfoWithResponseAsync(
            Context context) {
        final String accept = "application/json";
        return service.getResourceInfo(this.getEndpoint(), this.getApiVersion(), this.getApiVersion(), accept, context);
    }
